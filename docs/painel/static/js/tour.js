...
const TOUR_STEPS = [
  ...
  { id: "solar", section: "solar", target: '[data-section="solar"]', placement: "right",
    title: "Placa solar",
    body: "Quanto o telhado gera agora, para onde essa energia vai e quanto a loja deixou de pagar. A bateria guarda o excedente do meio-dia e devolve na hora cara — quando ela chega ao piso, os carregadores passam para a rede sozinhos." },
  ...
  { id: "fidelidade", section: "fidelidade", target: '[data-section="fidelidade"]', placement: "right",
    title: "Fidelidade e leilão",
    body: "Aqui se escolhe o programa que traz o cliente de volta — cashback, tiers ou créditos. É também onde se liga o leilão de potência: quando falta folga na rede, o motorista aceita carregar mais devagar em troca de mais crédito." },
  ...
  { id: "cadastros", section: null, target: '[data-nav-group="cadastros"]', placement: "right",
    ...
    body: "Cada painel é um arranjo de cards. Dá para ter um seu e um compartilhado com a loja, e trocar entre eles quando a pergunta do dia mudar." },
